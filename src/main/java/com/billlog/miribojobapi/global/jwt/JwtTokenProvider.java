...
public class JwtTokenProvider{
    ...
    public JwtTokenInfoVo generateToken(Authentication authentication /* , AccountInfo accountInfo */) {
        // 권한 가져오기
        ...
        String accessToken = Jwts.builder()
                ...
                .setSubject(accountInfo.getUserId())
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        if (claims.get("roles") == null) {
            throw new BillLogBusinessException("권한 정보가 없는 토큰입니다.");
        }
