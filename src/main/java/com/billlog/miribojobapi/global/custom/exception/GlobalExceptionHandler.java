package com.billlog.miribojobapi.global.custom.exception;

import com.billlog.miribojobapi.global.common.reponse.ApiResponseDTO;
import com.billlog.miribojobapi.global.common.reponse.ErrorCode;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BillLogBusinessException.class)
    public ResponseEntity<ApiResponseDTO<?>> handleKDBusinessException(BillLogBusinessException e) {
        return ResponseEntity.status(HttpStatus.OK).body(ApiResponseDTO.FAIL(e.getMessage()));
    }
}
